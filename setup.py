...
setup(
    name="Multi-Tool-Chat-Assistant",
    version="0.1.0",
    author="KumudithaSilva",
    author_email="kumudithasilva66@gmail.com",
    description="Multi-tool AI chat assistant for grocery stores",
    long_description=open("README.md").read(),
    long_description_content_type="",
    maintainer="kumuditha",
    maintainer_email="kumudithasilva66@gmail.com",
    url="https://github.com/KumudithaSilva/multi-tool-chat-assistant",
    project_urls={
        "Bug_Tracker": "https://github.com/KumudithaSilva/multi-tool-chat-assistant/issues"
    },
    package_dir={"": "src"},
